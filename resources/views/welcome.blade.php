...
<div class="welcome" >
    <div class="container">
     <header>   
                   ...
                   <img src="{{ asset('images/hajarr_log.png') }}" alt="Logo" style="width: 10%;">
          <h1 style=" width: 100%; font-weight: 900; font-family: 'Rubik', sans-serif; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);"> Complexe sidérurgique d'El Hadjar <br> Application de Gestion des stages </h1>
        ...
        <ul>
            ...
            <tbody id="offers-body">
                ...
                @else
            <h1 class="bebas-neue-regular" style="color:#ffffff;   width: 100%; font-weight: normal; padding: 20px;">Bienvenue dans L'Application de Gestion des offres de stage</h1>
                @endauth
