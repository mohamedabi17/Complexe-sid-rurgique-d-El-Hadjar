...
<ul>
    ...
    <li>
       <form action="{{ route('search.offres-stage') }}" method="GET" class="search-form">
                        <div class="search-input">
                            <input type="text"style="color: red;" name="query" placeholder="Rechercher offre de stage..." class="search-input-field">
                            <button type="submit"style="color: red;" class="search-submit-button"><img src="{{ asset('images/search.png') }}" alt="Logo" style="width: 60%;"></button>
                        </div>
                        <div class="additional-fields">
                            <input type="text"style="color: red;" name="entreprise_name" placeholder="Nom de l'entreprise..." class="additional-field">
                            <input type="text" style="color: red;"name="location" placeholder="Lieu..." class="additional-field">
                            <input type="text" style="color: red;"name="competence" placeholder="Compétences..." class="additional-field">
                        </div>
        </form>
    </li>
</ul>
     ...
     <h1 class="bebas-neue-regular"    style="color: black;">Gestion des Comptes</h1>
      <div class="row">
            <!-- Etudiants Card -->
            <div class="col-md-4">
                <div style="color: red;;background-color:black"class="newcard">
                    <div class="newcard-body">
                        <h5 style="color: red;;" class="newcard-title">Etudiants</h5>
            ...
            <div class="col-md-4">
                 <div style="color: red;;background-color:black"class="newcard">
                    <div class="newcard-body">
                        <h5 style="color: red;;" class="newcard-title"class="newcard-title">Pilotes</h5>
            ...
            <div class="col-md-4">
                <div class="newcard">
                    <div  style="color: red;;background-color:black"class="newcard">
                        <h5 style="color: red;;" class="newcard-title">Admins</h5>
            ...
            <div class="col-md-4">
                <div class="newcard">
                    <div  style="color: red;;background-color:black"class="newcard">
                        <h5 style="color: red;;" class="newcard-title">Users</h5>
            ...
            <div class="col-md-4">
                <div class="newcard">
                    <div  style="color: red;;background-color:black"class="newcard">
                        <h5 style="color: red;;" class="newcard-title">offers</h5>
                        <p class="newcard-text">View, update, and delete users records.</p>
    ...
    <div class="container">
        ...
        <div class="col-md-4">
            <div class="newcard">
                <div  style="color: red;;background-color:black"class="newcard">
                    <h5 style="color: red;;" class="newcard-title">Étudiant</h5>
        ...
        <div class="col-md-4">
            <div class="newcard">
                <div  style="color: red;;background-color:black"class="newcard">
                    <h5 style="color: red;;" class="newcard-title">Pilote de Promotion</h5>
